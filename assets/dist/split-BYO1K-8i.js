import { b as a, c as n } from "./actions-Fb_eg-U3.js";
...
window.addEventListener("alpine:init", () => {
  window.Alpine.data("splitForm", () => ({ isProcessing: false, percentage: 0, address: "", transactionHash: "", outputs: [], get parent() {
    ...
    this.transactionHash = "", s({ id: "payment", type: "info", text: i.paying }), this.isProcessing = true;
    let t;
    e === "all" ? t = await a(this.outputs) : t = await n(this.paymentAmount(), this.address), r("payment"), t.success ? (this.transactionHash = t.data.hash, s({ type: "info", text: t.data.message })) : s({ type: "warning", text: t.data }), this.isProcessing = false;
  } }));
});
