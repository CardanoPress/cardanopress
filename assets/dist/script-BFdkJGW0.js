import { h as w, a as f, b as g, l as y, c as x, m, p as C, d as b, e as v } from "./actions-Dz05HOjn.js";
import { a as t, c as a, r as n, E as c, s as l, g as P, b as r, d, e as h, f as p, i as u, h as W, w as E, C as A, B as S, u as T, j as M } from "./util-DUvjK3JZ.js";
window.addEventListener("alpine:init", () => {
  window.Alpine.data("cardanoPress", () => ({ isAvailable: window.cardano !== void 0 && window.cardanoPress !== void 0, isConnected: false, isProcessing: false, showModal: false, openDropdown: false, connectedExtension: "", selectedHandle: "", availableWallets: [], supportedWallets: [], has(e) {
    ...
    this.availableWallets = h.filter((e) => c.hasWallet(e));
  }, async init() {
    this.refreshWallets(), this.$watch("showModal", () => {
      this.refreshWallets();
    }), this.supportedWallets = h.filter((e) => {
      var _a;
      return (_a = this.$root.dataset.wallets) == null ? void 0 : _a.includes(e);
    }), d.logged ? (this.connectedExtension = p(), this.selectedHandle = this.$root.dataset.handle || "", this.isConnected = !!this.connectedExtension, this.isConnected && !u() && (t({ type: "success", text: a.connected }), r("true"))) : (u() && r("false"), p() && l(""));
  }, clipboardValue(e) {
    ...
    if (n("loginConnect"), s.success) {
      ...
      r("true"), this.showModal = false, this.isConnected = true, d.logged = "true", this.connectedExtension = e.type;
...
window.cardanoPress = { ...d, api: { ...v, ...M, ...T }, browser: { Extensions: c, supports: h }, buffer: S, csl: A, wallet: { delegationTx: b, paymentTx: C, multisendTx: m, ...E } };
