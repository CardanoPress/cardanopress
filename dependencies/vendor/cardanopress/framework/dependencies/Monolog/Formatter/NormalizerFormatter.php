...
use CardanoPress\Dependencies\Monolog\DateTimeImmutable;
...
class NormalizerFormatter implements FormatterInterface
{
    ...
    public function __construct(?string $dateFormat = null)
    {
        ...
        if (!function_exists('json_encode')) {
            throw new \RuntimeException('PHP\'s json extension is required to use CardanoPress\Dependencies\Monolog\'s NormalizerFormatter');
        }
    }
