...
class LogstashFormatter extends NormalizerFormatter
{
    ...
    /**
     * @var string the key for 'extra' fields from the CardanoPress\Dependencies\Monolog record
     */
    protected $extraKey;

    /**
     * @var string the key for 'context' fields from the CardanoPress\Dependencies\Monolog record
     */
