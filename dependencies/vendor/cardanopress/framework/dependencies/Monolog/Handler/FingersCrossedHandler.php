...
use CardanoPress\Dependencies\Monolog\Handler\FingersCrossed\ErrorLevelActivationStrategy;
use CardanoPress\Dependencies\Monolog\Handler\FingersCrossed\ActivationStrategyInterface;
use CardanoPress\Dependencies\Monolog\Logger;
use CardanoPress\Dependencies\Monolog\ResettableInterface;
 ...
 * CardanoPress\Dependencies\Monolog\Handler\FingersCrossed\ namespace.
 *
...
class FingersCrossedHandler extends Handler implements ProcessableHandlerInterface, ResettableInterface, FormattableHandlerInterface
{
    ...
    public function __construct($handler, $activationStrategy = null, int $bufferSize = 0, bool $bubble = true, bool $stopBuffering = true, $passthruLevel = null)
    {
        ...
        if (!$this->handler instanceof HandlerInterface && !is_callable($this->handler)) {
            throw new \RuntimeException("The given handler (".json_encode($this->handler).") is not a callable nor a CardanoPress\Dependencies\Monolog\Handler\HandlerInterface object");
        }
    }
