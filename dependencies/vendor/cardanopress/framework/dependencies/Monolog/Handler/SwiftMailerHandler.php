 ...
 * @deprecated Since CardanoPress\Dependencies\Monolog 2.6. Use SymfonyMailerHandler instead.
 */
class SwiftMailerHandler extends MailHandler
{
    ...
    public function __construct(\Swift_Mailer $mailer, $message, $level = Logger::ERROR, bool $bubble = true)
    {
        ...
        @trigger_error('The SwiftMailerHandler is deprecated since CardanoPress\Dependencies\Monolog 2.6. Use SymfonyMailerHandler instead.', E_USER_DEPRECATED);
