...
/**
 * CardanoPress\Dependencies\Monolog error handler
 *
...
class ErrorHandler
{
     ...
     * @param int              $reservedMemorySize Amount of KBs to reserve in memory so that it can be freed when handling fatal errors giving CardanoPress\Dependencies\Monolog some room in memory to get its job done
     */
