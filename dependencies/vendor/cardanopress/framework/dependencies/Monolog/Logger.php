...
namespace CardanoPress\Dependencies\Monolog;

use DateTimeZone;
use CardanoPress\Dependencies\Monolog\Handler\HandlerInterface;
use CardanoPress\Dependencies\Psr\Log\LoggerInterface;
use CardanoPress\Dependencies\Psr\Log\InvalidArgumentException;
use CardanoPress\Dependencies\Psr\Log\LogLevel;
use Throwable;
use Stringable;

/**
 * CardanoPress\Dependencies\Monolog log channel
 *
...
class Logger implements LoggerInterface, ResettableInterface
{
    ...
    /**
     * CardanoPress\Dependencies\Monolog API version
     *
    ...
    /**
     * Mapping between levels numbers defined in RFC 5424 and CardanoPress\Dependencies\Monolog ones
     *
     ...
     * there is no performance penalty and CardanoPress\Dependencies\Monolog 2 enabled microseconds
     ...
     * Adds a log record.
     *
     * @param  int               $level    The logging level (a CardanoPress\Dependencies\Monolog or RFC 5424 level)
     ...
     *
     * @throws \CardanoPress\Dependencies\Psr\Log\InvalidArgumentException If level is not defined
     *
     * @phpstan-param  Level     $level
    ...
    /**
     * Converts PSR-3 levels to CardanoPress\Dependencies\Monolog ones if necessary
     *
