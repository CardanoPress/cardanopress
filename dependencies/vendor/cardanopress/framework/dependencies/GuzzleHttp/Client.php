...
use CardanoPress\Dependencies\GuzzleHttp\Cookie\CookieJar;
use CardanoPress\Dependencies\GuzzleHttp\Exception\GuzzleException;
use CardanoPress\Dependencies\GuzzleHttp\Exception\InvalidArgumentException;
use CardanoPress\Dependencies\GuzzleHttp\Handler\CurlShareHandleState;
...
use CardanoPress\Dependencies\Psr\Http\Message\UriInterface;

/**
 * @final
 */
class Client implements ClientInterface, \CardanoPress\Dependencies\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
     ...
     *   CardanoPress\Dependencies\GuzzleHttp\Promise\PromiseInterface that is fulfilled with a
    ...
    private static function warnAboutInvalidRequestOptionTypes(array $options): void
    {
        ...
        if (isset($options['body']) && \is_array($options['body'])) {
            self::warnInvalidRequestOptionType('body', 'resource|string|null|int|float|bool|StreamInterface|(callable&object)|\Iterator|\CardanoPress_Dependency_CardanoPress_Dependency_Stringable', $options['body']);
        }
    ...
    private static function createBodyStream($body): StreamInterface
    {
        ...
        throw new InvalidArgumentException(\sprintf(
            'Passing %s to request option "body" is invalid; expected resource|string|null|int|float|bool|StreamInterface|callable&object|Iterator|CardanoPress_Dependency_CardanoPress_Dependency_Stringable.',
            \get_debug_type($body)
        ));
    }
