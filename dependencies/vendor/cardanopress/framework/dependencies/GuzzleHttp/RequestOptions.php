...
final class RequestOptions
{
    ...
    /**
     * body: (resource|string|null|int|float|bool|\CardanoPress\Dependencies\Psr\Http\Message\StreamInterface|(callable&object)|\Iterator|\CardanoPress_Dependency_CardanoPress_Dependency_Stringable)
    ...
    /**
     * cookies: (false|CardanoPress\Dependencies\GuzzleHttp\Cookie\CookieJarInterface, default=false)
    ...
    /**
     * sink: (resource|string|\CardanoPress\Dependencies\Psr\Http\Message\StreamInterface) Where the data
