...
use CardanoPress\Dependencies\GuzzleHttp\Handler\CurlHandler;
use CardanoPress\Dependencies\GuzzleHttp\Handler\CurlMultiHandler;
use CardanoPress\Dependencies\GuzzleHttp\Handler\CurlShareHandleState;
use CardanoPress\Dependencies\GuzzleHttp\Handler\CurlVersion;
use CardanoPress\Dependencies\GuzzleHttp\Handler\Proxy;
use CardanoPress\Dependencies\GuzzleHttp\Handler\StreamHandler;
...
final class Utils
{
    ...
    public static function chooseHandler(array $handlerOptions = []): callable
    {
        ...
        if (\ini_get('allow_url_fopen')) {
            ...
            throw new \RuntimeException('CardanoPress\Dependencies\GuzzleHttp requires cURL, the allow_url_fopen ini setting, or a custom HTTP handler.');
        }
