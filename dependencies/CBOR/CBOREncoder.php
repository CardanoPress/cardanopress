<?php
namespace CardanoPress\Dependencies\CBOR;

/**
 * CardanoPress\Dependencies\CBOR encoder/decoder
 *
...
class CBOREncoder
{
    ...
    /**
     * Encode variable to CardanoPress\Dependencies\CBOR binary format
     * @param mixed $var
     * @return null|string
     */
    public static function encode($var){
        switch(gettype($var))
        {
            ...
            case "string":
                ...
                break;
            case get_class($var) == 'CardanoPress\Dependencies\CBOR\Types\CBORByteString':
                /**
                 * @var \CardanoPress\Dependencies\CBOR\Types\CBORByteString $var
                 */
    ...
    /**
     * Decode CardanoPress\Dependencies\CBOR byte string
     * @param mixed $var
     * @throws \Exception
     * @return mixed
     */
        ...
        switch($major_type) {
            ...
            case self::MAJOR_TYPE_UTF8_STRING:
                ...
                if($major_type == self::MAJOR_TYPE_BYTE_STRING) {
                    $out = new \CardanoPress\Dependencies\CBOR\Types\CBORByteString($out);
                }
