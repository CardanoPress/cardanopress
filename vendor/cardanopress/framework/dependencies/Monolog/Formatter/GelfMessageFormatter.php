...
class GelfMessageFormatter extends NormalizerFormatter
{
    ...
    /**
     * @var string a prefix for 'extra' fields from the CardanoPress\Dependencies\Monolog record (optional)
     */
    protected $extraPrefix;

    /**
     * @var string a prefix for 'context' fields from the CardanoPress\Dependencies\Monolog record (optional)
     */
    ...
    /**
     * Translates CardanoPress\Dependencies\Monolog log levels to Graylog2 log priorities.
     *
     * @var array<int, int>
     *
    ...
    public function __construct(?string $systemName = null, ?string $extraPrefix = null, string $contextPrefix = 'ctxt_', ?int $maxLength = null)
    {
        if (!class_exists(Message::class)) {
            throw new \RuntimeException('Composer package graylog2/gelf-php is required to use CardanoPress\Dependencies\Monolog\'s GelfMessageFormatter');
        }
