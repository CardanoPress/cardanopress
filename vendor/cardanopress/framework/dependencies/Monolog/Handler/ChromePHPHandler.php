...
use CardanoPress\Dependencies\Monolog\Formatter\ChromePHPFormatter;
...
class ChromePHPHandler extends AbstractProcessingHandler
{
    ...
    public function __construct($level = Logger::DEBUG, bool $bubble = true)
    {
        ...
        if (!function_exists('json_encode')) {
            throw new \RuntimeException('PHP\'s json extension is required to use CardanoPress\Dependencies\Monolog\'s ChromePHPHandler');
        }
    }
