...
/**
 * CardanoPress\Dependencies\Monolog handler for Google Chrome extension "PHP Console"
 *
 ...
 *
 *      $logger = new \CardanoPress\Dependencies\Monolog\Logger('all', array(new \CardanoPress\Dependencies\Monolog\Handler\PHPConsoleHandler()));
 *      \CardanoPress\Dependencies\Monolog\ErrorHandler::register($logger);
 *      echo $undefinedVar;
 ...
 * @deprecated Since 2.8.0 and 3.2.0, PHPConsole is abandoned and thus we will drop this handler in CardanoPress\Dependencies\Monolog 4
 */
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    private $options = [
        ...
        'classesPartialsTraceIgnore' => ['CardanoPress\Dependencies\Monolog\\'], // array Hide calls of classes started with...
    ...
    /**
     * @param  array<string, mixed> $options   See \CardanoPress\Dependencies\Monolog\Handler\PHPConsoleHandler::$options for more details
