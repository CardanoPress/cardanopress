...
namespace CardanoPress\Dependencies\Monolog\Attribute;

/**
 * A reusable attribute to help configure a class or a method as a processor.
 * 
 * Using it offers no guarantee: it needs to be leveraged by a CardanoPress\Dependencies\Monolog third-party consumer.
 * 
 * Using it with the CardanoPress\Dependencies\Monolog library only has no effect at all: processors should still be turned into a callable if
